...
namespace SimpleAudio.ViewModels
{
    ...
    public class OldMediaSourceCollection
    {
        private readonly OldMediaSourceViewModel[] _sources;
        private readonly Timer _timer;

        public OldMediaSourceCollection(OldMediaSourceViewModel.Factory mediaSourceFactory, Settings settings)
        {
